...
type SiteSiteMetadataManifestFieldSelector = {
  ...
  readonly start_url: InputMaybe<FieldSelectorEnum>;
};

type SiteSiteMetadataManifestFilterInput = {
...
type SiteSiteMetadataManifestSortInput = {
  ...
  readonly start_url: InputMaybe<SortOrderEnum>;
};
...
type BioQueryQuery = { readonly site: { readonly siteMetadata: { readonly links: Record<string, unknown> | null, readonly author: { readonly name: string | null, readonly summary: string | null, readonly about: string | null } | null } | null } | null };
...
type BlogPostBySlugQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly mdx: { readonly id: string, readonly excerpt: string | null, readonly tableOfContents: Record<string, unknown> | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly description: string | null, readonly categories: ReadonlyArray<string | null> | null, readonly tags: ReadonlyArray<string | null> | null } | null } | null, readonly previous: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null, readonly next: { readonly fields: { readonly slug: string | null } | null, readonly frontmatter: { readonly title: string | null } | null } | null };
...
type HeadlessPostBySlugQueryVariables = Exact<{
  id: Scalars['String'];
}>;


type HeadlessPostBySlugQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } | null } | null, readonly mdx: { readonly id: string, readonly excerpt: string | null, readonly tableOfContents: Record<string, unknown> | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly description: string | null, readonly categories: ReadonlyArray<string | null> | null, readonly tags: ReadonlyArray<string | null> | null } | null } | null };
